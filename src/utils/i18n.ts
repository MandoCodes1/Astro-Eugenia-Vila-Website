export const translations = {
  es: {
    ...
    heroDescription: 'Especialista en implantes dentales, cirugía oral y alineadores. Dentista de confianza en Málaga con materiales de la más alta calidad y precios competitivos.',
    
    // Services
    servicesTitle: 'Nuestros Servicios',
    servicesSubtitle: 'Atención dental integral con tecnología de vanguardia',
    dentalImplants: 'Implantes Dentales',
    dentalImplantsDesc: 'Rehabilitaciones completas con implantes utilizando flujo de trabajo digital con imágenes CBCT y escaneo intraoral.',
    oralSurgery: 'Cirugía Oral',
    oralSurgeryDesc: 'Extracciones, injertos óseos, elevaciones de seno y procedimientos quirúrgicos avanzados.',
    aligners: 'Alineadores',
    alignersDesc: 'Tratamiento con alineadores transparentes para corrección de sonrisa sin brackets tradicionales.',
    cosmeticDentistry: 'Odontología Estética',
    cosmeticDentistryDesc: 'Carillas de porcelana, blanqueamiento dental y correcciones estéticas para tu sonrisa perfecta.',
    prosthetics: 'Prótesis',
    prostheticsDesc: 'Coronas, puentes y restauraciones protésicas completas con planificación digital.',
    bonding: 'Bonding',
    bondingDesc: 'Composite estético y reconstrucciones de dientes con materiales de la más alta calidad.',
    ...
    scheduleNote: 'La clínica está abierta esporádicamente cuando esté en Málaga. Por favor, contacta por WhatsApp para coordinar tu cita.',
  ...
  en: {
    ...
    heroDescription: 'Specialist in dental implants, oral surgery, and aligners. Trusted dentist in Málaga with the highest quality materials and competitive pricing.',
    
    // Services
    servicesTitle: 'Our Services',
    servicesSubtitle: 'Comprehensive dental care with cutting-edge technology',
    dentalImplants: 'Dental Implants',
    dentalImplantsDesc: 'Full-mouth rehabilitations with implants using digital workflow with CBCT imaging and intraoral scanning.',
    oralSurgery: 'Oral Surgery',
    oralSurgeryDesc: 'Extractions, bone grafts, sinus lifts, and advanced surgical procedures.',
    aligners: 'Aligners',
    alignersDesc: 'Clear aligner treatment for smile correction without traditional braces.',
    cosmeticDentistry: 'Cosmetic Dentistry',
    cosmeticDentistryDesc: 'Porcelain veneers, teeth whitening, and aesthetic corrections for your perfect smile.',
    prosthetics: 'Prosthetics',
    prostheticsDesc: 'Crowns, bridges, and full prosthetic restorations with digital planning.',
    bonding: 'Bonding',
    bondingDesc: 'Cosmetic composite and tooth reconstructions with the highest quality materials.',
    ...
    scheduleNote: 'The clinic is open sporadically when in Málaga. Please contact via WhatsApp to arrange your appointment.',
...
export function getAlternatePath(currentPath: string, targetLang: Language): string {
  ...
  return pathMap[currentPath]?.[targetLang] || (targetLang === 'es' ? '/es/' : '/en/');
}
